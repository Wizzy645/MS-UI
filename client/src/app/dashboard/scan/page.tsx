    ...
    <div className="p-6 text-white min-h-screen bg-gradient-to-b from-black to-[#0f172a]">
      ...
      <div className="relative mb-6">
        ...
        <button
          ...
          className="absolute bottom-2 right-2 bg-purple-700 hover:bg-purple-600 transition-all duration-200 text-white font-bold px-6 py-2 rounded-xl disabled:opacity-40 disabled:cursor-not-allowed hover:scale-105 flex items-center space-x-2"
        >
          {loading && (
